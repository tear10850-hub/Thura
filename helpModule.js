...
// စာမျက်နှာ ပို့ရန် သို့မဟုတ် ခလုတ်နှိပ်ပါက Message အဟောင်းဖျက်၍ အသစ်ပြန်ပြရန်
async function renderHelpPage(ctx, pageNum, isEdit = false) {
  ...
  // ခလုတ်နှိပ်၍ စာမျက်နှာပြောင်းပါက Message အဟောင်းကို ဖျက်မည်
  if (isEdit) {
    await ctx.deleteMessage().catch(() => {});
  }

  // ပုံ သို့မဟုတ် ဗီဒီယို ရှိမရှိ စစ်ဆေးပြီး အသစ်ပြန်ပို့မည်
