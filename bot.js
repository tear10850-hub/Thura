...
// ----------------------------------------------------
// 1. Modules များကို ဦးစားပေး ချိတ်ဆက်ခြင်း (အပေါ်ဆုံးတွင်ထားပါ)
// ----------------------------------------------------
setupAutoMuteModule(bot); // Link/Forward စစ်မည့်ဟာကို အရင်စစ်ခိုင်းမည်
...
// ----------------------------------------------------
// 2. Unified Message Handler (Modules တွေ စစ်ပြီးမှ ကျန်တာတွေကို ဒီက ဆက်လုပ်မည်)
// ----------------------------------------------------
...
// ----------------------------------------------------
// 6. မသုံးတာ ၁ လကျော်သော စာများ အလိုအလျောက် Clean Up လုပ်ခြင်း
// ----------------------------------------------------
setInterval(async () => {
  try {
