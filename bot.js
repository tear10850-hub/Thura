...
// 🟢 MODULES များကို အရင်ဆုံး ချိတ်ဆက်ပါ (Welcome/Leave စသည်တို့ အရင် အလုပ်လုပ်မည်)
...
// ----------------------------------------------------
// 🟢 Unified Message Handler (အဖွဲ့ဝင်အသစ် ဝင်လာချိန် မပိတ်ဆို့အောင် စစ်ဆေးပေးထားသည်)
// ----------------------------------------------------
bot.on('message', async (ctx, next) => {
  // အဖွဲ့ဝင်အသစ် သို့မဟုတ် အဖွဲ့ဝင်ထွက်သွားသည့် Event ဖြစ်ပါက Welcome/Leave Module သို့ ဆက်သွားရန် ကျော်ပေးမည်
