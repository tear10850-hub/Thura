...
const setupHelpModule = require('./helpModule'); // Help Module ပြန်ထည့်ထားသည်
...
// ----------------------------------------------------
// 1. Modules များကို အပေါ်ဆုံးတွင် ချိတ်ဆက်ခြင်း
// ----------------------------------------------------
...
setupHelpModule(bot, OWNER_ID); // Help Module ကို နေရာမှန်ကန်စွာ ထည့်သွင်းထားသည်
...
// ----------------------------------------------------
// 2. Unified Message Handler (Group နှင့် Private တွင် စကားပြန်ပေးရန်)
// ----------------------------------------------------
bot.on('message', async (ctx) => {
  try {
    ...
    // ၃။ မီဒီယာများ ရောက်လာပါက တုံ့ပြန်ရန်
