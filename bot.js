...
// စကားပြောသည့် အကြိမ်ရေ မှတ်ရန် Counter နှင့် Owner Media Mode (Default အနေဖြင့် ပိတ်ထားမည်)
let replyCounter = 0;
...
// ----------------------------------------------------
// ၄. Owner မီဒီယာသိမ်းဆည်းခြင်း (Toggle /open နှင့် /close စနစ်)
// ----------------------------------------------------
...
bot.on('message', async (ctx, next) => {
  try {
    ...
    // အကယ်၍ Media Mode ဖွင့်ထားပြီး Owner ဖြစ်ပါက မီဒီယာသိမ်းမည်
  ...
  // Group ထဲတွင် ဖြစ်ပါက သို့မဟုတ် Owner မဟုတ်ပါက (သို့) /close လုပ်ထားပါက ပုံမှန် မန်ဘာများနည်းတူ ဆက်သွားမည်
  await next();
});
