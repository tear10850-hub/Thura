...
import os
import random
from telegram import Update, ChatAction  # ✅ ChatAction ကို ဒီမှာ ထည့်ပါ
...
logger = logging.getLogger(__name__)  # ✅ __name__ လို့ ပြင်ပါ
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    welcome_text = "🤖 မင်္ဂလာပါ! ကျွန်တော် Bot စတင် အလုပ်လုပ်နေပါပြီခင်ဗျာ။ စာလုံးဘယ်လောက်ပဲ တိုတို အကုန်မှတ်ပြီး ပြန်ပြောပေးသွားပါမယ်။"
...
async def handle_group_messages(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        if message.text:
            ...
            # MongoDB ထဲသို့ အကုန်သိမ်းဆည်းခြင်း
            ...
            if all_messages:
                ...
                # Reply ပေးခြင်း (အစကနေ အဆုံးထိ အပြည့်အစုံပေါ်မည်)
...
if __name__ == "__main__":  # ✅ __name__ နဲ့ "__main__" လို့ ပြင်ပါ
    main()
