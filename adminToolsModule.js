...
// ၂။ Telegram Bot API မှ ခွင့်ပြုထားသော Emojis စာရင်း
...
function setupAdminToolsModule(bot) {
  ...
  // ====================================================
  // /adminpf - Admin များ စာရင်းပြခြင်း (Bot ကို နောက်ဆုံးတွင် ပြသမည်)
  // ====================================================
  bot.command('adminpf', async (ctx) => {
    ...
    try {
      ...
      for (const admin of administrators) {
        ...
        let userBio = "မရှိပါ";
        try {
          const fullUser = await ctx.api.getChat(u.id);
   ...
   🔗 **Username:** ${username}\n   📝 **Bio:** ${userBio}\n----------------------------------`;
      ...
      let botBio = "မရှိပါ";
      try {
        const fullBot = await ctx.api.getChat(botInfo.id);
        if (fullBot.bio) botBio = fullBot.bio;
      } catch (err) {}
  ...
  // ====================================================
  // BOT မှတစ်ဆင့် ADMIN ခန့်ခြင်း / ဖြုတ်ခြင်း COMMANDS
  // ====================================================
  ...
  // ====================================================
  // REAL-TIME EVENT: GROUP တွင်း ADMIN အပြောင်းအလဲကို စောင့်ကြည့်ပြီး သတိပေးခြင်း
  // ====================================================
